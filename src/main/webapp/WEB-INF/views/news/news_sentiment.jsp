	...
	$('#searchButton').on('click',function(){
		...
		$.ajax({
			...
			for(var i = 0; i<searchList.length; i++){
				...
				html += '<a class="btn" href="#ex2" rel="modal:open" onclick="ModalWordcloud(\''+searchList[i].article + '\')">워드클라우드</a>'
				html += '</figure>';
			}
			// console.log(html);
			$("#columns").html(html);
		...
		$.ajax({
			...
			success : function(dateList){
				...
				for(var i = 0; i<dateList.length; i++){
					...
					html += '<a class="btn" href="#ex2" rel="modal:open" onclick="ModalWordcloud(\''+dateList[i].article + '\')">워드클라우드</a>'		
					html += '</figure>';
				}
				// console.log(html);
				$("#columns").html(html);
		...
		$.ajax({
			...
			success : function(popularList){
				...
				for(var i = 0; i<popularList.length; i++){
					...
					html += '<a class="btn" href="#ex2" rel="modal:open" onclick="ModalWordcloud(\''+popularList[i].article + '\')">워드클라우드</a>'
					html += '</figure>';
				}
				// console.log(html);
				$("#columns").html(html);
		...
		<header id="header">
			...
			<section id="main" class="container">
				...
				<div id="ex2" align="center" class="modal" >
					<h3 id="title">Wordcloud Analysis</h3>
